...
//
// The bright daytime counterpart to warp.frag: a luminous violet→teal→gold
// field where the bulk of the surface carries colour (warp.frag inverts this to
// a near-black field with sparse glowing crests, for a dark room). Pair them in
// a --list with --dark-hours to swap by time of day.
//
//   prism-bg --shader examples/shaders/warp-bright.frag
#version 450
